...
import ConstantsController from "./controllers/data-site/constants/ConstantsController";
...
const constantsController = new ConstantsController();
const upload = multer();
...
routes.get(
  "/list-player-options",
  verifyJWT,
  playerController.listTeamsOptions
);
routes.get(
  "/list-championship-cp",
  verifyJWT,
  championshipController.listChampionshipCP
);
...
routes.post("/login-ra", constantsController.loginConstant);
